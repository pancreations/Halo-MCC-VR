...
if (-not (Test-ExactInt32 $manifest.schema_version 22) -or
        ...
        -not $packageId.StartsWith(
            $head.Substring(0, 7) + '-halo2-c29-tick-locked-head-fp-interpolation-reset-',
        ...
        [string]$manifest.halo2_candidate.id -cne 'C-H2-29' -or
        ...
        [string]$manifest.halo2_candidate.behavior -cne
            'both-cores-fp-weapon-world-frustum-tick-locked-head-sample-fp-interpolation-reset' -or
