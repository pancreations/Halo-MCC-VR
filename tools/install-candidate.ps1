...
if (-not (Test-ExactInt32 $manifest.schema_version 22) -or
        ...
        -not $packageId.StartsWith(
            $head.Substring(0, 7) + '-halo2-c26-fp-projection-hud-per-eye-published-pose-',
        ...
        [string]$manifest.halo2_candidate.id -cne 'C-H2-26' -or
        ...
        [string]$manifest.halo2_candidate.behavior -cne
            'both-cores-saber-fp-projection-unified-hud-replayed-per-eye-observer-published-pose' -or
