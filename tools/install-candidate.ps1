...
if (-not (Test-ExactInt32 $manifest.schema_version 22) -or
        ...
        -not $packageId.StartsWith(
            $head.Substring(0, 7) + '-halo2-c30-frame-head-sample-latch-classic-capture-rotation-',
        ...
        [string]$manifest.halo2_candidate.id -cne 'C-H2-30' -or
        ...
        [string]$manifest.halo2_candidate.behavior -cne
            'one-head-sample-per-frame-latched-at-the-weapon-placement-classic-capture-candidate-rotation' -or
