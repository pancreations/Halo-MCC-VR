...
if (-not (Test-ExactInt32 $manifest.schema_version 22) -or
        ...
        -not $packageId.StartsWith(
            $head.Substring(0, 7) + '-halo2-c21-gamepad-back-swallow-pause-chord-',
        ...
        [string]$manifest.halo2_candidate.id -cne 'C-H2-21' -or
        ...
        [string]$manifest.halo2_candidate.behavior -cne
            'both-cores-engine-projection-readback-crop-saber-aspect-locked-cover-no-synthetic-back' -or
