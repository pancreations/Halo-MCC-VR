...
- The centered game reticle still depends on the remembered observed element id. The assault-rifle crosshair was headset-picked as 0x62C / 1580 and is now the built-in default; a multi-id hide list remains the next fix if weapon variance persists.
